...
public class ActionSkillBook : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        skillBar.GetComponent<ActionSkillUsing>().LoadSkillBar();
       ...
       string aNames = string.Empty;
        ...
        foreach (string a in skillBar.GetComponent<ActionSkillUsing>().splitSkillSlots)
        {
    ...
    void Update()
    {
        ...
        for (int i = 0; i < abilities1.Length; i++)
        {
            ...
            if (abilities1[i].tag == "Skill")
            {
                ...
                abilities1[i].GetComponentInChildren<SwitchSkills>().spellButton = "InactiveButton";
            }
